  ...
  protected routes(): RouteConfig[] {
    return [
      ...
      },
      {
        ...
        middlewares: [
          AuthMiddleware.authenticateUser,
          validationMiddleware(CreateGroupExpenseDto, "body"),
        ],
        handler: GroupController.createExpense,
      },
      {
        method: "get",
        path: "/:id/expenses",
        middlewares: [AuthMiddleware.authenticateUser],
        handler: GroupController.listExpenses,
      },
      {
        method: "get",
        path: "/:id/balances",
        middlewares: [AuthMiddleware.authenticateUser],
        handler: GroupController.balances,
      },
      {
        method: "get",
        path: "/:id/settlements",
        middlewares: [AuthMiddleware.authenticateUser],
        handler: GroupController.settlements,
      },
    ];
  }
}
